                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center gap-3 transition-all border-2 relative
...
const ClimateVisualizer: React.FC = () => {
    ...
    return (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {forecastData.length > 0 ? forecastData.map((day, idx) => {
                            ...
                            const dayAbbrevMap: Record<string, string> = {
                                'MON': '#f0fdf4', // Light Emerald
                                'TUE': '#eff6ff', // Light Blue
                                'WED': '#faf5ff', // Light Purple
                                'THU': '#fff7ed', // Light Orange
                                'FRI': '#fdf2f8', // Light Pink
                                'SAT': '#f9fafb', // Light Gray
                                'SUN': '#fffbeb'  // Light Amber
                            };
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 w-full">
                                        ...
                                        <h3 className="text-sm font-black tracking-tight uppercase leading-tight transition-colors mt-3" style={{ color: themeColor }}>
                                            {day.condition}
                                        </h3>
                                    </div>
        ...
        #three-day-node-forecast .forecast-card[data-day="MON"] { background-color: #f0fdf4 !important; }
        #three-day-node-forecast .forecast-card[data-day="TUE"] { background-color: #eff6ff !important; }
        #three-day-node-forecast .forecast-card[data-day="WED"] { background-color: #faf5ff !important; }
        #three-day-node-forecast .forecast-card[data-day="THU"] { background-color: #fff7ed !important; }
        #three-day-node-forecast .forecast-card[data-day="FRI"] { background-color: #fdf2f8 !important; }
        #three-day-node-forecast .forecast-card[data-day="SAT"] { background-color: #f9fafb !important; }
        #three-day-node-forecast .forecast-card[data-day="SUN"] { background-color: #fffbeb !important; }
      `}</style>
        </div>
    );
};
